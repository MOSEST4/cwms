...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Jet Car Washing management System | Home Page</title>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>UGX</span><strong>30,000</strong></h2>
                            </div>
                            ...
                            <a class="btn btn-custom" onclick="initiatePayment('Basic Cleaning', 30000)">Book Now</a>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>UGX</span><strong>50,000</strong></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
                            ...
                            <div class="price-footer">
                            <a class="btn btn-custom" onclick="initiatePayment('Premium Cleaning', 50000)">Book Now</a>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>UGX</span><strong>70,000</strong></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
                            ...
                            <div class="price-footer">
                            <a class="btn btn-custom" onclick="initiatePayment('Complex Cleaning', 70000)">Book Now</a>
      ...
      <div class="modal-body">
        <form id="paymentForm">
          <div class="form-group">
            ...
            <input type="tel" class="form-control" id="phone" placeholder="e.g. 2567XXXXXXXX" required>
          </div>
          <div class="form-group">
