    ...
    <body>
        ...
        <div class="page-header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2> Our Washing Plan Pricing</h2>
                    </div>
                    <div class="col-12">
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (UGX:30,000.00)</option>
                 <option value="2">PREMIUM CLEANING (UGX:50,000.00)</option>
                  <option value="3 ">COMPLEX CLEANING(UGX:70,000.00)</option>
              </select>
